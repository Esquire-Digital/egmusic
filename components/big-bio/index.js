  ...
  return (
    <>
      <section className="relative z-10 flex flex-col items-start pt-32 lg:pt-48 lg:flex-row bg-eg-epk-1">
        <h1 className="mx-auto text-6xl leading-none text-center uppercase lg:absolute lg:inset-x-0 lg:top-0 lg:z-10 font-ant md:text-mega lg:text-mighty xl:text-monster text-eg-black lg:leading-relaxed">
          Emily Gabriele
        </h1>

export default function Grid() {
  return (
    ...
    >
      ...
      <p
        className="absolute inset-x-0 bottom-0 z-10 text-6xl font-normal leading-none text-center text-transparent uppercase transform translate-y-4 opacity-25 md:text-mighty md:translate-y-16 lg:text-massive font-ant"
        style={{

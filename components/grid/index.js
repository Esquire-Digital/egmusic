export default function Grid() {
  return (
    <section className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      ...
      <p
        className="absolute inset-x-0 bottom-0 z-10 text-6xl leading-none text-center text-transparent uppercase transform translate-y-4 opacity-25 md:text-mighty md:translate-y-16 lg:text-massive font-ant"
        style={{
